...
public class FrameTest {
	...
	private void addFrameContent() {
		...
		JTextField text = new JTextField("campo de texto");
		frame.add(text);
		...
		/* abreviatura para passar por cima da criação de uma classe de uma interface
		 * especificando os métodos obrigatórios dessa interface
		 * */
		frame.add(button);	
	}
